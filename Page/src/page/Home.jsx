  ...
  return (
    <main>
        ...
        <section id="about" className="flex flex-col w-screen h-screen bg-coolblack md:justify-center md:items-center px-[1.25rem] md:py-64 py-48 gap-y-8">
            <div id="about-content-wrapper" className="text-offwhite font-bold 2xl:leading-[140%] sm:leading-[110%] leading-[101%] relative 2xl:max-w-[1000px] lg:max-w-[800px] md:max-w-[600px] sm:max-w-[500px] max-w-[20rem] text-[2.75rem]">
        ...
        <section id="footer-hero" className="w-screen h-screen bg-coolblack">
            <div id="footer-video" className="absolute">
                <video
                autoPlay
                muted
                loop
        ...
        <footer id="footer-section" className="flex sm:flex-row flex-col sm:justify-evenly sm:items-center w-screen h-fit bg-coolblack py-12 px-6 gap-y-8">
            ...
            <div id="contact-info" className="flex flex-col w-fit h-auto gap-y-12 sm:mt-0 mt-16">
                <div id="email-wrapper" className="flex flex-col gap-y-2">
                    <span className="text-lg text-rusticoffwhite font-bold">Email</span>
                    <span className="md:text-lg text-sm text-offwhite">mylesmcghee1999@yahoo.com</span>
                </div>
                <div id="phone-wrapper" className="flex flex-col gap-y-2">
                    <span className="text-lg text-rusticoffwhite font-bold">Phone</span>
